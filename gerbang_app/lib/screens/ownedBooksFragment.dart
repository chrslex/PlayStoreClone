...
class OwnedBookFragment extends StatefulWidget {
  @override
  OwnedBookFragmentState createState() =>
      OwnedBookFragmentState();
}

class OwnedBookFragmentState
    extends State<OwnedBookFragment> {
  int maxItemCount = 20;
  int? group = 1;
